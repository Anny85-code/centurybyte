...
const Footer = () => {
    ...
    return ( <
        ...
        Stop wasting time and money designing and managing strategy that doesn’ t get results.Happiness guaranteed!
        <
        /p> <
        ...
        <
        div style = {
            { backgroundColor: '#2b2b2b', borderTop: 'solid 1px #707070' } } >
        <
